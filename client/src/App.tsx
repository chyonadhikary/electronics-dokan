...
function HomePage({ products, navigate, addToCart }: { products: Product[]; navigate: (path: string) => void; addToCart: (id: string, qty?: number) => void }) {
  ...
  return <div>
    ...
    <div className="container promise-strip"><div><span className="promise-icon"><Truck size={18} /></span><span><b>Nationwide delivery</b><small>Bangladesh Post Office & Steadfast</small></span></div><div><span className="promise-icon"><BadgeCheck size={18} /></span><span><b>Selected with care</b><small>Practical parts, fair prices</small></span></div><div><span className="promise-icon"><MessageCircle size={18} /></span><span><b>Easy WhatsApp order</b><small>No account required</small></span></div><div><span className="promise-icon"><Heart size={18} /></span><span><b>Builder-first support</b><small>From Phultala, Khulna</small></span></div></div>
    <section className="section container homepage-products"><SectionHeading eyebrow="Start with something good" title="Featured picks" action="See all products" onAction={() => navigate("/products")} /><ProductGrid products={featured} navigate={navigate} addToCart={addToCart} /></section>
